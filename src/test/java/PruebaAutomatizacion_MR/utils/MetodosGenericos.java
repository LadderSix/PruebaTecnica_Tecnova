...
public class MetodosGenericos {
	...
	public static void accionClick(WebElement element) {
		try {
			element.click();
		} catch (Exception e) {
			System.out.println("No se puede encontrar el elemento: " + e.getMessage());
			Assert.fail();
		}
	...
	public static void accionSenkeys(WebElement element, String dato) {
		try {
			element.sendKeys(dato);
		} catch (Exception e) {
			System.out.println("No se puede interactuar con el elemento: " + e.getMessage());
			Assert.fail();
		}

	}

	public static void accionClear(WebElement element) {
		try {
			element.clear();
		} catch (Exception e) {
			Assert.fail();
	...
	public static boolean validarEstadoBotones(WebElement element) {
